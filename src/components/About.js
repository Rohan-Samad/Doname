...
export default function About() {
 ...
 <>
    ...
    <div id="services" className="section absoulte z-10 mt-7 pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
        <div className="container flex flex-wrap xl:max-w-6xl mx-auto px-4">
         
            <header className="text-center mx-auto mb-12 lg:px-20">
                <h2 className="text-2xl leading-normal mb-2 font-bold text-black">About The Doname by Rohan-Samad</h2>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 60" style={{margin: 'auto',height: 35+'px'}} >
                ...
                <p className="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">It Provides you the facilities to determine the Perfect Available Domain very Easily</p>
            </header>
            ...
            <div className="flex flex-wrap flex-row -mx-4 text-center">
                <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{visibility: 'visible', animationDuration: 1+'s', animationName: 'fadeInUp'}}>
                    ...
                    <div className="py-8 px-12 mb-12 -z-10 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                        ...
                        <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Ease of Access</h3>
                        <p className="text-gray-500">You can safely Search Directly without login or signup setup.</p>
                    </div>
                  
                </div>
                <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style={{visibility: 'visible', animationDuration: 1+'s', animationDelay: 0.1+'s', animationName: 'fadeInUp'}}>
                    ...
                    <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                        ...
                        <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Security Maintenance</h3>
                        <p className="text-gray-500">It will Save Your Data Safely It has Many authentication procedure so that You can Safely access Your data.</p>
                    </div>
                  
                </div>
                <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style={{visibility: 'visible', animationDuration: 1+'s', animationDelay: 0.3+'s', animationName: 'fadeInUp'}}>
                    ...
                    <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                        ...
                        <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Connect Forever</h3>
                        <p className="text-gray-500">It Provides You the Facilty Of access Your Notes At Any Time.</p>
                    </div>
